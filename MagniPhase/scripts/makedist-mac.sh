...
NOTARIZE_BUNDLE_ID=com.TonNomSansEspace.MagniPhase
NOTARIZE_BUNDLE_ID_DEMO=com.TonNomSansEspace.MagniPhase.DEMO
...
#if [ $DEMO == 1 ]
#then
#  git checkout installer/MagniPhase.iss
#  git checkout installer/MagniPhase.pkgproj
