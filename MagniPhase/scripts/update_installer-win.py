...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=MagniPhase Demo Installer\n"
      else:
        line="OutputBaseFilename=MagniPhase Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the MagniPhase Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the MagniPhase installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=MagniPhase Demo installer\n"
     else:
       line="SetupWindowTitle=MagniPhase installer\n"
